// CONTROLLER FILE TAKES THE LOGIC OUT OF THE ROUTES FILE AND PASTE IT IN HERE
// LOOK TO USER.JS IN ROUTES FOR THE CORRESPONDING FUNCTION PARAMETERS AND CALLBACKS

import { v4 as uuidv4 } from 'uuid';  // first run 'npm install uuid' -- this makes sure users have unique IDs
uuidv4(); 

// let users = [];  // data stored in this array for API use

  //MOCK DATA FOR THE API TO USE
let users = [  
    {
        firstName: "John",
        lastName: "Doe",
...
export const getUserById = (req, res) => { // the ":" takes any parameter after the slash. will display anything
...
export const deleteUser = (req,res) => { // deletes a specific id based on the id parameters
...
export const updateUser = (req, res) => {  // patch updates an item partially but not the entire item ex: lastName
